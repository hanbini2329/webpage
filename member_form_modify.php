...
<?
  ...
  // 아래문자 위의문장 수정한 내용
    $sql = "select * from join_page where id='$_SESSION[userid]'";
            ...
            <div class="wrap">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="password" id="pwd1" name="pwd1" placeholder="비밀번호" value="<?= $row['pwd1'] ?>">
                    </li>
                    <li>
                        <label class="skip" for="pwd2">비밀번호 확인</label>
                        <input type="password" id="pwd2" name="pwd2" placeholder="비밀번호 확인" value="<?= $row['pwd1'] ?>">
                    </li>
                    <li>
                        <label class="skip" for="email">이메일</label>
                        <input type="email" id="email" name="email" placeholder="이메일" value="<?= $row['email'] ?>">
                    </li>
                    <li>
                        <label class="skip" for="name">이름</label>
                        <input type="text" id="name" name="name" placeholder="이름" value="<?= $row['name'] ?>">
                    </li>
                    <li>
                        <label class="skip" for="birth">생년월일</label>
                        <input type="text" id="birth" name="birth" placeholder="생년월일 8자리" value="<?= $row['birth'] ?>">
                    </li>
                    <li>
                        <label class="skip" for="hp">전화번호</label>
                        <input type="tel" id="hp" name="hp" placeholder="전화번호" value="<?= $row['hp'] ?>">
                    </li>
                    <li>
                        <label class="skip" for="adr">주소</label>
                        <input type="text" id="adr" name="addr" placeholder="주소" value="<?= $row['addr'] ?>">
                    </li>
                </ul>
            </div>
            <div id="button">
                <a href="index.html" onclick="reset_form()">돌아가기</a>
                <a href="javascript:void(0)" onclick="check_input()">수정하기</a>
            </div>
        </form>
    </fieldset>
    <div class="best_list">
