...
<body>
    ...
    <div class="back_img">
        <img src="img/member_back.png" alt="배경이미지">
    </div>
    <fieldset id="join_page">
        <form name="member_form" method="post" action="pw_search.php">
            <div id="join2">
                <ul>
                    <li>
                        <label class="skip" for="pid">ID </label>
                        <input type="text" name="id" placeholder="아이디를 입력해주세요." id="pid">
                    </li>
                    <li>
                        <label class="skip" for="a2" class="b2">HP</label>
                        <input type="text" class="hp" name="hp" placeholder="전화번호를 입력해주세요.">
                    </li>
                </ul>
            </div>
            <div id="write_button"><input type="submit" value="비밀번호 찾기"></div>
        </form>
    </fieldset>
    <div class="best_list">
        <ul id="slick01">
