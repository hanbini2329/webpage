<? 
	...
	$a_item_subject     = $row['subject'];
	$a_item_content     = $row['content'];
?>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrap">
  <div id="content">
	<div id="col2">        
		...
		<div class="clear"></div>
		<div id="write_form_title">리뷰수정</div>
		<div class="clear"></div>
		<form  name="board_form" method="post" action="insert1.php?mode=modify&num=<?=$num?>&page=<?=$page?>"> 
		    <div id="write_form">
		    	...
		    	<div id="write_row2">
                    ...
                    <div class="col2"><input type="text" name="subject" value="<?=$a_item_subject?>" ></div>
		    	</div>
		    	<div class="write_line"></div>
		    	<div id="write_row3">
                    <div class="col1">내용</div>
		    	    <div class="col2"><textarea name="content"><?=$a_item_content?></textarea></div>
		    	</div>
		    	<div class="write_line"></div>
		    </div>
